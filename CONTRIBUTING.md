...
- **Instructions only.** These skills are prose instructions plus reference files — no scripts, no binaries, no network calls beyond what the user's own request requires. Please keep it that way; it's what makes them portable and safe to install.
